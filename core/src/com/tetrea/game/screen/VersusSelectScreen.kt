...
import com.tetrea.game.scene.dialog.*
...
class VersusSelectScreen(game: TetreaGame) : BaseScreen(game), LateDisposable, SelectionDialogCallback {
    ...
    private val helpDialog = VersusHelpDialog(game.res, true)
    ...
    override fun show() {
        ...
        val headerTable = Table().apply {
            ...
            add(game.res.getLabel("YOUR RATING: ${game.player.rating.toInt()} (${game.player.maxRating.toInt()} PEAK)", color = GAME_YELLOW))
        }
